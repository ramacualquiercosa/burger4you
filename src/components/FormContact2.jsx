...
function FormContact2() {
  return (
    <>
    <section class="min-h-screen max-w-2xl mx-auto  bg-black px-4  sm:px-6  lg:max-w-7xl lg:px-8 pt-8" data-aos="zoom-in">
    <div class="container mx-auto flex min-h-screen flex-col px-6 py-12">
        ...
        <div class="text-white lg:mx-6 lg:w-1/2">
            <h1 class="text-3xl font-semibold capitalize lg:text-5xl">Contactanos</h1>
            ...
            <p class="-mx-2 flex items-start">
                ...
                <span class="mx-2 w-72 truncate text-white"> Salta Nº 4632, C.A.B.A. </span>
            </p>
            ...
            <p class="-mx-2 flex items-start">
                ...
                <span class="mx-2 w-72 truncate text-white">(11) 563-7401</span>
            </p>
            ...
            <p class="-mx-2 flex items-start">
                ...
                <span class="mx-2 w-72 truncate text-white">Burger4U@example.com</span>
            </p>
            </div>

            <div class="mt-6 md:mt-8">
            <h3 class="text-gray-300">Seguinos</h3>
        ...
        <div class="mt-8 lg:mx-6 lg:w-1/2">
            <div class="mx-auto w-full overflow-hidden rounded-xl bg-red-900 px-8 py-10 shadow-2xl dark:bg-gray-900 lg:max-w-xl">
            <h1 class="text-2xl font-medium text-white dark:text-gray-200">Contact form</h1>

            <form class="mt-6">
                <div class="flex-1">
                <label class="mb-2 block text-sm text-white dark:text-gray-200">Full Name</label>
                <input type="text" placeholder="Burger 4 U" class="mt-2 block w-full rounded-md border border-gray-200 bg-white px-5 py-3 text-gray-700 focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:focus:border-blue-300" />
                </div>

                <div class="mt-6 flex-1">
                <label class="mb-2 block text-sm text-white dark:text-gray-200">Email address</label>
                <input type="email" placeholder="Burger4U@example.com" class="mt-2 block w-full rounded-md border border-gray-200 bg-white px-5 py-3 text-gray-700 focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:focus:border-blue-300" />
                </div>

                <div class="mt-6 w-full">
                <label class="mb-2 block text-sm text-white dark:text-gray-200">Message</label>
