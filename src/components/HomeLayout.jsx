...
function HomeLayout() {
  return (
	...
	<section class="w-full bg-cover bg-center py-32 rounded-lg" style={{ backgroundImage: `url('https://www.infobae.com/new-resizer/7SRvZWr_kQpTejEGhUeMhWZvtmo=/768x432/filters:format(webp):quality(85)/arc-anglerfish-arc2-prod-infobae.s3.amazonaws.com/public/POXG5OOLHNFO3CY2E3I3ZFDMDA')` }}>
